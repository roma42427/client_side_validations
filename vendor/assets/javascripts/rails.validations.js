  ...
  window.ClientSideValidations.enablers = {
    ...
    input: function(input) {
      ...
      return $input.filter('[id$=_confirmation]').each(function() {
        var confirmationElement, parentElement, ref1, results;
        confirmationElement = $(this);
        confirmationElement.on('focusin.ClientSideValidations', function() {
          return confirmationElement.data('focusedIn', true);
        });
